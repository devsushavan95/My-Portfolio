  ...
  return (
    <section className="py-20">
      <div className="container">
        <motion.h2 className="text-[4rem] leading-none mb-12 max-md:text-center" initial={initialFadeInState} whileInView={finalFadeInState} transition={{ duration: 0.3 }} viewport={{ once: true }}>
          Tools & Technologies <span className="size-4 rounded-full inline-block bg-brand"></span>
        </motion.h2>
